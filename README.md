...
[Chapter 7 of Expert Python Programming Book, Packt Publishing, 2008 by Tarek Ziadé]

[Python Geospatial Development, Packt Publishing, 2010 by Erik Westra]
...
You'll hav to load the [bootstrap.py (latest version)](http://svn.zope.org/*checkout*/zc.buildout/trunk/bootstrap/bootstrap.py) file into this READMEs folder:
